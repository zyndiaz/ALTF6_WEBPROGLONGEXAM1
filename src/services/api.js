...
export const api = {
  ...
  createProduct: (details) => request("/products", { method: "POST", body: JSON.stringify(details) }),
  updateProduct: (id, details) => request(`/products/${id}`, { method: "PATCH", body: JSON.stringify(details) }),
